...
// https://github.com/Inncoder/SwiftUI-Animations/blob/master/Animations/Reddit/Reddit.swift

import SwiftUI

struct BlobAnimation: View {
    ...
    @State private var time: Double = 4
    ...
    var body: some View {
        VStack {
            ZStack {
                ...
                ZStack {
                    Fluid(time: CGFloat(time*3.2), width: width+5, height: height, curveHeight: curveHeight, curveLength: curveLength)
                        .fill(color)
                        .frame(width: width, height: height)
